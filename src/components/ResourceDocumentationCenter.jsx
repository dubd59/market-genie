...
const ResourceDocumentationCenter = () => {
  ...
  const documentationSections = [
    ...
    {
      id: 'ai-swarm-automation',
      title: 'AI Swarm & Automation',
      icon: '🧠',
      description: 'AI agents, workflow automation, and background processing',
                  ...
                  <div className="space-y-3 text-sm text-green-700">
                    <div className="border-l-4 border-green-500 pl-4">
                      ...
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                        ...
                        <li><strong>AI Swarm:</strong> Multiple AI agents working simultaneously</li>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-blue-700">
                    ...
                    <div className="border-l-4 border-blue-500 pl-4">
                      <p className="font-semibold">Twitter/X Lead Mining</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-blue-500 pl-4">
                      <p className="font-semibold">Social Listening Setup</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                ...
                <div className="bg-purple-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-purple-700">
                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">Automatic Scoring Criteria</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">Manual Qualification Process</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">Lead Categorization</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                ...
                <div className="bg-orange-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-orange-700">
                    ...
                    <div className="border-l-4 border-orange-500 pl-4">
                      <p className="font-semibold">Lead Lifecycle Tracking</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                <div className="bg-purple-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-purple-700">
                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">Step 1: Define Your Funnel Goal</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">Step 2: AI Prompt Configuration</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">Step 3: AI Generation Process</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">Step 4: Review and Refine</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-blue-700">
                    <div className="border-l-4 border-blue-500 pl-4">
                      <p className="font-semibold">Design Customization</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-blue-500 pl-4">
                      <p className="font-semibold">Content Optimization</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-green-700">
                    <div className="border-l-4 border-green-500 pl-4">
                      <p className="font-semibold">Setting Up A/B Tests</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-green-500 pl-4">
                      <p className="font-semibold">Tracking and Analytics</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-green-500 pl-4">
                      <p className="font-semibold">Optimization Strategies</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                ...
                <div className="bg-orange-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-orange-700">
                    ...
                    <div className="border-l-4 border-orange-500 pl-4">
                      <p className="font-semibold">Integration Setup</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-blue-700">
                    <div className="border-l-4 border-blue-500 pl-4">
                      <p className="font-semibold">LinkedIn Setup & Safety</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-blue-500 pl-4">
                      <p className="font-semibold">Connection Request Strategy</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-blue-500 pl-4">
                      <p className="font-semibold">Follow-up Sequence</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-blue-500 pl-4">
                      <p className="font-semibold">Engagement Tactics</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-green-700">
                    <div className="border-l-4 border-green-500 pl-4">
                      <p className="font-semibold">Channel Integration Strategy</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-green-500 pl-4">
                      <p className="font-semibold">Coordinated Messaging</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-green-500 pl-4">
                      <p className="font-semibold">Response Management</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                ...
                <div className="bg-purple-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-purple-700">
                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">Key Metrics to Track</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">A/B Testing Elements</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">Reporting Dashboard</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-green-700">
                    <div className="border-l-4 border-green-500 pl-4">
                      <p className="font-semibold">How Revenue Sharing Works</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-green-500 pl-4">
                      <p className="font-semibold">Revenue Examples</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-blue-700">
                    <div className="border-l-4 border-blue-500 pl-4">
                      <p className="font-semibold">Ideal Partner Profile</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-blue-500 pl-4">
                      <p className="font-semibold">Perfect Customer Segments</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                ...
                <div className="bg-purple-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-purple-700">
                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">Timeline to Profitability</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">Growth Strategies</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
              ...
              <div className="space-y-6">
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-blue-700">
                    ...
                    <div className="border-l-4 border-blue-500 pl-4">
                      <p className="font-semibold">Qualification Criteria</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-green-700">
                    <div className="border-l-4 border-green-500 pl-4">
                      <p className="font-semibold">Week 1: Setup & Configuration</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-green-500 pl-4">
                      <p className="font-semibold">Week 2: Training & Testing</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-green-500 pl-4">
                      <p className="font-semibold">Week 3-4: Launch Preparation</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-green-700">
                    <div className="border-l-4 border-green-500 pl-4">
                      <p className="font-semibold">How to Create Signup Links</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-green-500 pl-4">
                      <p className="font-semibold">Link Tracking Features</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-blue-700">
                    <div className="border-l-4 border-blue-500 pl-4">
                      <p className="font-semibold">Creating Custom Pricing</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-blue-500 pl-4">
                      <p className="font-semibold">Proposal Generation</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                ...
                <div className="bg-purple-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-purple-700">
                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">Available Marketing Assets</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                <div className="bg-orange-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-orange-700">
                    <div className="border-l-4 border-orange-500 pl-4">
                      <p className="font-semibold">Start with Existing Clients</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-orange-500 pl-4">
                      <p className="font-semibold">Effective Sales Approach</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-orange-500 pl-4">
                      <p className="font-semibold">Scaling Techniques</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-orange-500 pl-4">
                      <p className="font-semibold">Customer Success & Retention</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
  ...
  // AI Swarm & Automation Content
  const AISwarmAutomationContent = () => (
    <div className="space-y-8">
      <div className="bg-gradient-to-r from-purple-50 to-indigo-50 p-6 rounded-lg border border-purple-200">
        <h2 className="text-2xl font-bold text-purple-800 mb-4">🧠 AI Swarm & Automation Workflows</h2>
        <p className="text-purple-700 mb-4">Understand and control Market Genie's powerful AI automation system. Multiple AI agents work together to automate your entire marketing process.</p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-200">
          <h3 className="text-xl font-bold text-gray-800 mb-4 flex items-center gap-2">
            <span>🤖</span> AI Swarm System
          </h3>
          
          {expandedAPISection !== 'ai-swarm-overview' ? (
            <>
              <div className="space-y-4 text-gray-700">
                <div className="bg-purple-50 p-4 rounded-lg">
                  <h4 className="font-bold text-purple-800">What is AI Swarm?</h4>
                  <p className="text-purple-700 text-sm">6 specialized AI agents working simultaneously on different marketing tasks</p>
                </div>
                <ul className="space-y-2 text-sm">
                  <li>• 🕵️ <strong>Lead Hunter AI:</strong> Finds prospects on LinkedIn & social media</li>
                  <li>• ✍️ <strong>Content Wizard:</strong> Creates personalized emails & content</li>
                  <li>• 📧 <strong>Email Orchestrator:</strong> Manages email campaigns & sequences</li>
                  <li>• 📱 <strong>Social Media Manager:</strong> Handles social outreach</li>
                  <li>• 📊 <strong>Data Analyst:</strong> Tracks performance & optimization</li>
                  <li>• 📡 <strong>Multi-Channel Coordinator:</strong> Coordinates all channels</li>
                </ul>
              </div>
              <button 
                onClick={() => setExpandedAPISection('ai-swarm-overview')}
                className="mt-4 bg-purple-600 text-white px-4 py-2 rounded-lg hover:bg-purple-700 transition-colors w-full"
              >
                🧠 View Complete AI Swarm Guide
              </button>
            </>
          ) : (
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                <div className="bg-purple-50 p-4 rounded-lg">
                  <h4 className="font-bold text-purple-800 mb-3">🚀 How AI Swarm Works</h4>
                  <div className="space-y-3 text-sm text-purple-700">
                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">Parallel Processing Power</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                        <li>All 6 AI agents run simultaneously, not sequentially</li>
                        <li>Each agent specializes in specific marketing functions</li>
                        <li>Agents communicate and share data for coordinated campaigns</li>
                        <li>Real-time performance monitoring and optimization</li>
                        <li>Automatic load balancing based on task complexity</li>
                      </ul>
                    </div>
                    
                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">Agent Responsibilities</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                        <li><strong>Lead Hunter AI:</strong> Scrapes LinkedIn, finds decision makers, validates contacts</li>
                        <li><strong>Content Wizard:</strong> Generates personalized emails, subject lines, social posts</li>
                        <li><strong>Email Orchestrator:</strong> Manages sending schedules, A/B tests, deliverability</li>
                        <li><strong>Social Media Manager:</strong> LinkedIn messages, Twitter DMs, Facebook outreach</li>
                        <li><strong>Data Analyst:</strong> Tracks opens, clicks, responses, conversion rates</li>
                        <li><strong>Multi-Channel Coordinator:</strong> Ensures consistent messaging across platforms</li>
                      </ul>
                    </div>

                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">Activation & Control</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                        <li><strong>Manual Start:</strong> Navigate to "AI Swarm" in main dashboard</li>
                        <li><strong>Swarm Status:</strong> Shows Idle, Running, or Paused</li>
                        <li><strong>Individual Control:</strong> Activate/pause specific agents as needed</li>
                        <li><strong>Performance Metrics:</strong> Real-time tasks completed, efficiency rates</li>
                        <li><strong>Cost Monitoring:</strong> Daily spend tracking and budget alerts</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  <h4 className="font-bold text-green-800 mb-3">⚙️ Configuration Best Practices</h4>
                  <div className="space-y-3 text-sm text-green-700">
                    <div className="border-l-4 border-green-500 pl-4">
                      <p className="font-semibold">Initial Setup</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                        <li>Ensure all API keys are configured (OpenAI, Prospeo, Microsoft)</li>
                        <li>Set daily budget limits to control AI usage costs</li>
                        <li>Configure lead scoring criteria for quality filtering</li>
                        <li>Set up email templates and content guidelines</li>
                        <li>Define target audience parameters and exclusions</li>
                      </ul>
                    </div>
                    ...
                    <div className="border-l-4 border-green-500 pl-4">
                      ...
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                        <li>Start with 2-3 agents active, then scale up gradually</li>
                        <li>Monitor agent efficiency scores and adjust workloads</li>
                        <li>Use A/B testing for content optimization</li>
                        <li>Review daily reports to identify bottlenecks</li>
                        <li>Adjust agent priorities based on business goals</li>
                      </ul>
                    </div>
                    ...
                    <div className="border-l-4 border-green-500 pl-4">
                      ...
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                        <li>Check swarm status indicator (green = running, yellow = paused)</li>
                        <li>Review completed tasks counter for productivity tracking</li>
                        <li>Monitor cost per lead and conversion metrics</li>
                        <li>Watch for agent efficiency drops (below 80% needs attention)</li>
                        <li>Set up alerts for budget thresholds and performance issues</li>
                      </ul>
                    </div>
                  </div>
                </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-200">
          ...
          {expandedAPISection !== 'workflow-automation' ? (
            <>
              <div className="space-y-4 text-gray-700">
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h4 className="font-bold text-blue-800">What are Workflows?</h4>
                  <p className="text-blue-700 text-sm">Trigger-based automation sequences that respond to specific actions</p>
                </div>
                <ul className="space-y-2 text-sm">
                  <li>• 🎯 <strong>Lead Nurturing:</strong> Automated follow-up sequences</li>
                  <li>• 📧 <strong>Email Drip Campaigns:</strong> Scheduled message series</li>
                  <li>• 🔔 <strong>Smart Notifications:</strong> Real-time alerts and updates</li>
                  <li>• 📊 <strong>Lead Scoring:</strong> Automatic prospect prioritization</li>
                  <li>• 🤝 <strong>Meeting Scheduling:</strong> AI calendar coordination</li>
                </ul>
              </div>
              <button 
                onClick={() => setExpandedAPISection('workflow-automation')}
                className="mt-4 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors w-full"
              >
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h4 className="font-bold text-blue-800 mb-3">🔄 How Workflows Operate</h4>
                  <div className="space-y-3 text-sm text-blue-700">
                    <div className="border-l-4 border-blue-500 pl-4">
                      <p className="font-semibold">Trigger-Based Automation</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                        <li><strong>New Lead Added:</strong> Automatically starts welcome sequence</li>
                        <li><strong>Email Opened:</strong> Triggers follow-up message or next sequence step</li>
                        <li><strong>Link Clicked:</strong> Tags lead as engaged and adjusts messaging</li>
                        <li><strong>Form Submitted:</strong> Immediately notifies sales team and starts nurturing</li>
                        <li><strong>Time-Based:</strong> Sends messages after specific delays (1 day, 1 week, etc.)</li>
                      </ul>
                    </div>
                    
                    <div className="border-l-4 border-blue-500 pl-4">
                      <p className="font-semibold">Workflow Types Available</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                        <li><strong>Lead Nurturing Sequence:</strong> Welcome → Education → Offer → Close</li>
                        <li><strong>Re-engagement Campaign:</strong> Win back inactive leads</li>
                        <li><strong>Customer Onboarding:</strong> Guide new customers through setup</li>
                        <li><strong>Lead Scoring Workflow:</strong> Automatically prioritize prospects</li>
                        <li><strong>Email Drip Campaign:</strong> Scheduled educational content series</li>
                        <li><strong>Event-Based Follow-up:</strong> Post-webinar or demo sequences</li>
                      </ul>
                    </div>

                    <div className="border-l-4 border-blue-500 pl-4">
                      <p className="font-semibold">Creating Custom Workflows</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                        <li>Access "Workflow Automation" section in main dashboard</li>
                        <li>Use AI Assistant to generate workflows from natural language</li>
                        <li>Choose from pre-built templates for common scenarios</li>
                        <li>Set triggers, actions, delays, and conditions</li>
                ...
                <div className="bg-orange-50 p-4 rounded-lg">
                  <h4 className="font-bold text-orange-800 mb-3">🔗 AI Swarm + Workflow Integration</h4>
                  <div className="space-y-3 text-sm text-orange-700">
                    <div className="border-l-4 border-orange-500 pl-4">
                      <p className="font-semibold">How They Work Together</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                        <li><strong>Lead Discovery:</strong> AI Swarm finds prospects → Workflows nurture them</li>
                        <li><strong>Content Creation:</strong> Content Wizard generates messages → Workflows deliver them</li>
                        <li><strong>Performance Optimization:</strong> Data Analyst tracks results → Workflows adjust</li>
                        <li><strong>Multi-Channel Coordination:</strong> Agents manage platforms → Workflows sequence timing</li>
                        <li><strong>Intelligent Handoffs:</strong> Swarm qualifies leads → Workflows route to sales</li>
                      </ul>
                    </div>
                    
                    <div className="border-l-4 border-orange-500 pl-4">
                      <p className="font-semibold">Background vs Manual Operation</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                        <li><strong>Workflows:</strong> Run automatically in background once activated</li>
                        <li><strong>AI Swarm:</strong> Requires manual start but then runs continuously</li>
                        <li><strong>Best Practice:</strong> Start AI Swarm first, then enable workflows</li>
                        <li><strong>Monitoring:</strong> Both systems provide real-time status indicators</li>
                        <li><strong>Cost Control:</strong> Set daily limits to prevent budget overruns</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-red-50 p-4 rounded-lg">
                  <h4 className="font-bold text-red-800 mb-3">⚠️ Current Status Issues</h4>
                  <div className="space-y-3 text-sm text-red-700">
                    <div className="border-l-4 border-red-500 pl-4">
                      <p className="font-semibold">Known Issues & Solutions</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                        <li><strong>Placeholder Data:</strong> Some metrics show simulated values until real data accumulates</li>
                        <li><strong>Manual Activation Required:</strong> AI Swarm starts in "idle" state for cost control</li>
                        <li><strong>API Dependencies:</strong> Requires OpenAI, Prospeo, and other API keys to function</li>
                        <li><strong>Learning Curve:</strong> System optimizes performance over first few days of use</li>
                        <li><strong>Budget Controls:</strong> May pause if daily spending limits are reached</li>
                      </ul>
                    </div>
                  </div>
                </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-200">
          ...
          {expandedAPISection !== 'ai-quick-start' ? (
            <>
              <div className="space-y-4 text-gray-700">
                <div className="bg-green-50 p-4 rounded-lg">
                  <h4 className="font-bold text-green-800">Get Started in 5 Steps</h4>
                  <p className="text-green-700 text-sm">From setup to automation in under 30 minutes</p>
                </div>
                <ol className="space-y-2 text-sm">
                  <li>1. ⚙️ Configure API keys (OpenAI, Prospeo, Microsoft)</li>
                  <li>2. 🎯 Set lead generation criteria and budget limits</li>
                  <li>3. 🧠 Navigate to AI Swarm and click "Start Swarm"</li>
                  <li>4. ⚡ Create your first workflow using AI Assistant</li>
                  <li>5. 📊 Monitor performance and optimize settings</li>
                </ol>
              </div>
              <button 
                onClick={() => setExpandedAPISection('ai-quick-start')}
                className="mt-4 bg-green-600 text-white px-4 py-2 rounded-lg hover:bg-green-700 transition-colors w-full"
              >
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                <div className="bg-green-50 p-4 rounded-lg">
                  <h4 className="font-bold text-green-800 mb-3">🚀 Complete Setup Process</h4>
                  <div className="space-y-4 text-sm text-green-700">
                    <div className="border-l-4 border-green-500 pl-4 bg-green-100 p-3 rounded">
                      <p className="font-semibold text-green-900">Step 1: Configure API Integrations (15 minutes)</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                        <li>Go to "API Keys & Integrations" in Resource Center</li>
                        <li>Set up OpenAI API for AI content generation</li>
                        <li>Configure Prospeo API for email verification</li>
                        <li>Optional: Microsoft OAuth for calendar integration</li>
                        <li>Test all connections before proceeding</li>
                      </ul>
                    </div>
                    
                    <div className="border-l-4 border-green-500 pl-4 bg-green-100 p-3 rounded">
                      <p className="font-semibold text-green-900">Step 2: Set Campaign Parameters (5 minutes)</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                        <li>Define target audience criteria (job titles, company size, industry)</li>
                        <li>Set daily budget limits for AI usage ($50-200 recommended)</li>
                        <li>Configure lead scoring parameters and quality thresholds</li>
                        <li>Set geographic targeting and exclusion rules</li>
                        <li>Choose content tone and messaging style preferences</li>
                      </ul>
                    </div>

                    <div className="border-l-4 border-green-500 pl-4 bg-green-100 p-3 rounded">
                      <p className="font-semibold text-green-900">Step 3: Activate AI Swarm (2 minutes)</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                        <li>Navigate to main dashboard and click "AI Swarm" button</li>
                        <li>Review swarm status (should show "Idle" initially)</li>
                        <li>Click "Start Swarm" button to activate all agents</li>
                        <li>Watch status change to "Running" with green indicator</li>
                        <li>Verify agents start showing activity and task completion</li>
                      </ul>
                    </div>

                    <div className="border-l-4 border-green-500 pl-4 bg-green-100 p-3 rounded">
                      <p className="font-semibold text-green-900">Step 4: Create Automation Workflows (5 minutes)</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                        <li>Go to "Workflow Automation" section</li>
                        <li>Click "Create Workflow" or use AI Assistant</li>
                        <li>Start with "Lead Nurturing Sequence" template</li>
                        <li>Customize email templates and timing delays</li>
                        <li>Activate workflow to start processing new leads</li>
                      </ul>
                    </div>

                    <div className="border-l-4 border-green-500 pl-4 bg-green-100 p-3 rounded">
                      <p className="font-semibold text-green-900">Step 5: Monitor & Optimize (Ongoing)</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                        <li>Check AI Swarm dashboard for real-time performance metrics</li>
                        <li>Review workflow completion rates and engagement stats</li>
                        <li>Adjust agent priorities based on results</li>
                        <li>Optimize content based on open/click rates</li>
                        <li>Scale up successful workflows and pause underperformers</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h4 className="font-bold text-blue-800 mb-3">💡 Pro Tips for Success</h4>
                  <div className="space-y-2 text-sm text-blue-700">
                    <ul className="space-y-1 list-disc ml-4">
                      <li><strong>Start Small:</strong> Begin with 2-3 agents and scale up as you learn</li>
                      <li><strong>Monitor Costs:</strong> Set conservative budget limits initially</li>
                      <li><strong>Test Content:</strong> Use A/B testing for subject lines and messaging</li>
                      <li><strong>Quality Over Quantity:</strong> Focus on high-scoring leads for better results</li>
                      <li><strong>Regular Review:</strong> Check performance weekly and adjust strategies</li>
                    </ul>
                  </div>
                </div>
              </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-200">
          ...
          {expandedAPISection !== 'ai-monitoring' ? (
            <>
              <div className="space-y-4 text-gray-700">
                <div className="bg-yellow-50 p-4 rounded-lg">
                  <h4 className="font-bold text-yellow-800">Track Your Success</h4>
                  <p className="text-yellow-700 text-sm">Real-time metrics and performance indicators</p>
                </div>
                <ul className="space-y-2 text-sm">
                  <li>• 📈 <strong>Swarm Metrics:</strong> Tasks completed, efficiency rates, costs</li>
                  <li>• ⚡ <strong>Workflow Stats:</strong> Triggers fired, sequences completed</li>
                  <li>• 🎯 <strong>Lead Quality:</strong> Scoring distribution and conversion rates</li>
                  <li>• 💰 <strong>ROI Tracking:</strong> Cost per lead and revenue attribution</li>
                  <li>• 🔔 <strong>Alert System:</strong> Budget warnings and performance issues</li>
                </ul>
              </div>
              <button 
                onClick={() => setExpandedAPISection('ai-monitoring')}
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                <div className="bg-yellow-50 p-4 rounded-lg">
                  <h4 className="font-bold text-yellow-800 mb-3">📈 Key Performance Indicators</h4>
                  <div className="space-y-3 text-sm text-yellow-700">
                    <div className="border-l-4 border-yellow-500 pl-4">
                      <p className="font-semibold">AI Swarm Metrics to Watch</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                        <li><strong>Agent Efficiency:</strong> Should be 80%+ (adjust workload if lower)</li>
                        <li><strong>Tasks Completed Today:</strong> Tracks daily productivity</li>
                        <li><strong>Active Agents:</strong> Number of agents currently working</li>
                        <li><strong>Cost Per Day:</strong> Monitor against your budget limits</li>
                        <li><strong>Leads Generated:</strong> New prospects found by Lead Hunter AI</li>
                        <li><strong>Content Created:</strong> Emails, posts, messages generated</li>
                      </ul>
                    </div>
                    
                    <div className="border-l-4 border-yellow-500 pl-4">
                      <p className="font-semibold">Workflow Performance Indicators</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                        <li><strong>Active Workflows:</strong> Number of automation sequences running</li>
                        <li><strong>Triggers Fired Today:</strong> How many workflows were activated</li>
                        <li><strong>Completion Rate:</strong> % of workflows that finish successfully</li>
                        <li><strong>Email Open Rate:</strong> Engagement with automated messages</li>
                        <li><strong>Response Rate:</strong> Replies and interactions generated</li>
                        <li><strong>Conversion Rate:</strong> Leads that become customers</li>
                      </ul>
                    </div>

                    <div className="border-l-4 border-yellow-500 pl-4">
                      <p className="font-semibold">Warning Signs to Address</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                        <li><strong>Agent Efficiency Below 70%:</strong> Reduce workload or check API limits</li>
                        <li><strong>High Cost Per Lead:</strong> Optimize targeting or content quality</li>
                        <li><strong>Low Workflow Completion:</strong> Check for trigger issues or delays</li>
                        <li><strong>Declining Open Rates:</strong> Refresh email templates and subject lines</li>
                        <li><strong>Budget Alerts:</strong> Adjust spending limits or upgrade plan</li>
                      </ul>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-purple-50 p-4 rounded-lg">
                  <h4 className="font-bold text-purple-800 mb-3">🎯 Optimization Strategies</h4>
                  <div className="space-y-3 text-sm text-purple-700">
                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">Performance Improvement Tactics</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                        <li><strong>A/B Testing:</strong> Test different email subject lines and content</li>
                        <li><strong>Agent Rebalancing:</strong> Shift workload to highest-performing agents</li>
                        <li><strong>Timing Optimization:</strong> Adjust send times based on engagement data</li>
                        <li><strong>Audience Refinement:</strong> Narrow targeting based on conversion data</li>
                        <li><strong>Content Personalization:</strong> Increase AI personalization levels</li>
                      </ul>
                    </div>
                    
                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">Scaling Best Practices</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                        <li><strong>Gradual Increase:</strong> Add 1-2 workflows per week</li>
                        <li><strong>Budget Scaling:</strong> Increase limits only after proving ROI</li>
                        <li><strong>Agent Activation:</strong> Enable new agents once current ones optimize</li>
                        <li><strong>Quality Gates:</strong> Maintain lead quality as volume increases</li>
                        <li><strong>Regular Review:</strong> Weekly performance reviews and adjustments</li>
                      </ul>
                    </div>
                  </div>
                </div>
      ...
      <div className="bg-gradient-to-r from-purple-100 to-blue-100 p-6 rounded-lg border border-purple-200">
        <h3 className="text-lg font-bold text-purple-800 mb-4">🎯 Ready to Activate Your AI Marketing Army?</h3>
        <div className="grid md:grid-cols-2 gap-4">
          <div>
            <h4 className="font-bold text-purple-700 mb-2">🧠 AI Swarm Dashboard</h4>
            <p className="text-sm text-purple-600 mb-3">Start your AI agents and monitor their performance</p>
            <button 
              onClick={() => window.location.hash = '#ai-swarm'}
          ...
          <div>
            <h4 className="font-bold text-blue-700 mb-2">⚡ Workflow Automation</h4>
            <p className="text-sm text-blue-600 mb-3">Create automated marketing sequences</p>
            <button 
              onClick={() => window.location.hash = '#workflow-automation'}
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-blue-700">
                    <div className="border-l-4 border-blue-500 pl-4">
                      <p className="font-semibold">Step 1: Sign Up for Prospeo</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-blue-500 pl-4">
                      <p className="font-semibold">Step 2: Generate API Key</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-green-700">
                    <div className="border-l-4 border-green-500 pl-4">
                      <p className="font-semibold">Email Verification Settings</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-green-500 pl-4">
                      <p className="font-semibold">Rate Limiting & Credits</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-green-500 pl-4">
                      <p className="font-semibold">Data Enrichment Options</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                ...
                <div className="bg-purple-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-purple-700">
                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">Testing Your Setup</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                <div className="bg-purple-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-purple-700">
                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">Step 1: Create OpenAI Account</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">Step 2: Configure Billing</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">Step 3: Generate API Key</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-blue-700">
                    <div className="border-l-4 border-blue-500 pl-4">
                      <p className="font-semibold">Model Selection</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-blue-500 pl-4">
                      <p className="font-semibold">Usage Optimization</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                ...
                <div className="bg-orange-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-orange-700">
                    <div className="border-l-4 border-orange-500 pl-4">
                      <p className="font-semibold">Budgeting Guidelines</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-orange-500 pl-4">
                      <p className="font-semibold">Cost Optimization Tips</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                  ...
                  <div className="space-y-3 text-sm text-orange-700">
                    ...
                    <div className="border-l-4 border-orange-500 pl-4">
                      ...
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                        ...
                        <li>Redirect URI: "Web" → "https://market-genie-f2d41.web.app/oauth/callback"</li>
  ...
  const TermsOfServiceContent = () => (
    <div className="space-y-8">
      ...
      <div className="grid gap-6">
        ...
        <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-200">
          <h3 className="text-2xl font-bold text-gray-800 mb-4">5. Fees and Payment</h3>
          
          <div className="space-y-4">
            <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
              <h4 className="text-lg font-bold text-purple-800 mb-2">5.1 Subscription Fees</h4>
            ...
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
              <h4 className="text-lg font-bold text-blue-800 mb-2">5.2 Payment Processing</h4>
            ...
            <div className="bg-red-50 p-4 rounded-lg border border-red-200">
              <h4 className="text-lg font-bold text-red-800 mb-2">5.3 Refunds</h4>
        ...
        <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-200">
          <h3 className="text-2xl font-bold text-gray-800 mb-4">6. Acceptable Use</h3>
          <p className="text-gray-700 mb-3 font-semibold">You agree not to:</p>
          <div className="bg-red-50 p-4 rounded-lg border border-red-200">
            <ul className="space-y-2 text-red-700">
        ...
        <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-200">
          ...
          <div className="space-y-4">
            <div className="bg-indigo-50 p-4 rounded-lg border border-indigo-200">
              <h4 className="text-lg font-bold text-indigo-800 mb-2">7.1 Our Rights</h4>
              <p className="text-indigo-700 mb-2">We own all rights, title, and interest in:</p>
            ...
            <div className="bg-green-50 p-4 rounded-lg border border-green-200">
              <h4 className="text-lg font-bold text-green-800 mb-2">7.2 Your Data</h4>
              <p className="text-green-700 mb-2">You retain ownership of your customer data. You grant us a license to:</p>
            ...
            <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
              <h4 className="text-lg font-bold text-yellow-800 mb-2">7.3 AI-Generated Content</h4>
        ...
        <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-200">
          ...
          <p className="text-gray-700 mb-3 font-semibold">To the maximum extent permitted by law:</p>
          <div className="bg-red-50 p-4 rounded-lg border border-red-200">
            <ul className="space-y-2 text-red-700">
        ...
        <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-200">
          <h3 className="text-2xl font-bold text-gray-800 mb-4">13. Dispute Resolution</h3>
          
          <div className="space-y-4">
            <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
              <h4 className="text-lg font-bold text-blue-800 mb-2">13.1 Governing Law</h4>
              <p className="text-blue-700">These terms are governed by the laws of Colorado, USA.</p>
            </div>

            <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
              <h4 className="text-lg font-bold text-purple-800 mb-2">13.2 Arbitration</h4>
              <p className="text-purple-700">Any disputes shall be resolved through binding arbitration in Colorado Springs, CO.</p>
            </div>

            <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
              <h4 className="text-lg font-bold text-yellow-800 mb-2">13.3 Class Action Waiver</h4>
              <p className="text-yellow-700">You waive any right to participate in class actions.</p>
            </div>
          </div>
        </div>
        ...
        {/* Contact Information */}
        <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-200">
          <h3 className="text-2xl font-bold text-gray-800 mb-4">15. Contact Information</h3>
          <div className="bg-gradient-to-r from-indigo-50 to-blue-50 p-4 rounded-lg border border-indigo-200">
            <div className="space-y-2">
              <p className="text-indigo-800">
                <strong>Email:</strong> <a href="mailto:Help@dubdproducts.com" className="text-indigo-600 hover:text-indigo-800 underline">Help@dubdproducts.com</a>
        ...
        <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-200">
          <h3 className="text-2xl font-bold text-gray-800 mb-4">AI-Specific Disclaimer</h3>
          <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
            <h4 className="text-lg font-bold text-yellow-800 mb-3">AI Limitations Acknowledgement</h4>
            <p className="text-yellow-700 mb-3">Market Genie uses artificial intelligence and machine learning technologies. You acknowledge that:</p>
            <ul className="space-y-2 text-yellow-700">
  ...
  const SupportContactContent = () => (
    <div className="space-y-8">
      <div className="bg-gradient-to-r from-indigo-50 to-blue-50 p-6 rounded-lg border border-indigo-200">
        <h2 className="text-2xl font-bold text-indigo-800 mb-4">📞 Support & Contact Information</h2>
        ...
        <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-200">
          ...
          <div className="space-y-4">
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-4 rounded-lg border border-green-200">
              <h4 className="font-bold text-green-800 mb-2">🤖 Instant AI Responses</h4>
  ...
  const TroubleshootingContent = () => (
    <div className="space-y-8">
      <div className="bg-gradient-to-r from-red-50 to-pink-50 p-6 rounded-lg border border-red-200">
        <h2 className="text-2xl font-bold text-red-800 mb-4">🛠️ Troubleshooting & Common Issues</h2>
        ...
        <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-200">
          ...
          {expandedAPISection !== 'lead-issues' ? (
            <>
              <div className="space-y-4 text-gray-700">
                <div className="bg-blue-50 p-4 rounded-lg">
                  <h4 className="font-bold text-blue-800">Common Problems:</h4>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                <div className="bg-red-50 p-4 rounded-lg">
                  <h4 className="font-bold text-red-800 mb-3">🚫 No Leads Found Issues</h4>
                  <div className="space-y-3 text-sm text-red-700">
                    <div className="border-l-4 border-red-500 pl-4">
                      <p className="font-semibold">Problem: Search returns empty results</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-red-500 pl-4">
                      <p className="font-semibold">Problem: Scraper finds very few results</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                ...
                <div className="bg-orange-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-orange-700">
                    <div className="border-l-4 border-orange-500 pl-4">
                      <p className="font-semibold">Problem: Emails showing as invalid/unverified</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-orange-500 pl-4">
                      <p className="font-semibold">Problem: Verification process too slow</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                ...
                <div className="bg-yellow-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-yellow-700">
                    <div className="border-l-4 border-yellow-500 pl-4">
                      <p className="font-semibold">Problem: Scraper timing out or crashing</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-yellow-500 pl-4">
                      <p className="font-semibold">Problem: Export functionality not working</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
        ...
        <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-200">
          ...
          {expandedAPISection !== 'funnel-issues' ? (
            <>
              <div className="space-y-4 text-gray-700">
                <div className="bg-purple-50 p-4 rounded-lg">
                  <h4 className="font-bold text-purple-800">Common Problems:</h4>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                <div className="bg-purple-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-purple-700">
                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">Problem: AI not generating relevant content</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">Problem: AI generation timing out or failing</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-blue-700">
                    <div className="border-l-4 border-blue-500 pl-4">
                      <p className="font-semibold">Problem: Funnel preview not displaying correctly</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-blue-500 pl-4">
                      <p className="font-semibold">Problem: Customizations not saving properly</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-green-700">
                    <div className="border-l-4 border-green-500 pl-4">
                      <p className="font-semibold">Problem: Funnel won't publish or deploy</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-green-500 pl-4">
                      <p className="font-semibold">Problem: Published funnel not loading for visitors</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
        ...
        <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-200">
          ...
          {expandedAPISection !== 'auth-issues' ? (
            <>
              <div className="space-y-4 text-gray-700">
                <div className="bg-red-50 p-4 rounded-lg">
                  <h4 className="font-bold text-red-800">Common Problems:</h4>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                <div className="bg-red-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-red-700">
                    <div className="border-l-4 border-red-500 pl-4">
                      <p className="font-semibold">Problem: Cannot log in with correct credentials</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-red-500 pl-4">
                      <p className="font-semibold">Problem: Account appears locked or suspended</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                ...
                <div className="bg-orange-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-orange-700">
                    <div className="border-l-4 border-orange-500 pl-4">
                      <p className="font-semibold">Problem: Not receiving password reset emails</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-orange-500 pl-4">
                      <p className="font-semibold">Problem: Reset link expired or not working</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                ...
                <div className="bg-purple-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-purple-700">
                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">Problem: 2FA codes not working or expired</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-purple-500 pl-4">
                      <p className="font-semibold">Problem: Lost access to authenticator device</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
        ...
        <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-200">
          ...
          {expandedAPISection !== 'api-issues' ? (
            <>
              <div className="space-y-4 text-gray-700">
                <div className="bg-green-50 p-4 rounded-lg">
                  <h4 className="font-bold text-green-800">Common Problems:</h4>
                  <p className="text-green-700 text-sm">API connection failures, integration errors, sync issues</p>
                </div>
                <ul className="space-y-2 text-sm">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                <div className="bg-green-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-green-700">
                    <div className="border-l-4 border-green-500 pl-4">
                      <p className="font-semibold">Problem: API keys showing as invalid or expired</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-green-500 pl-4">
                      <p className="font-semibold">Problem: API rate limits being exceeded</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-blue-700">
                    <div className="border-l-4 border-blue-500 pl-4">
                      <p className="font-semibold">Problem: Data not syncing between services</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-blue-500 pl-4">
                      <p className="font-semibold">Problem: Webhook delivery failures</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                ...
                <div className="bg-yellow-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-3 text-sm text-yellow-700">
                    <div className="border-l-4 border-yellow-500 pl-4">
                      <p className="font-semibold">Prospeo API Issues</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-yellow-500 pl-4">
                      <p className="font-semibold">OpenAI API Issues</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
                    ...
                    <div className="border-l-4 border-yellow-500 pl-4">
                      <p className="font-semibold">Microsoft OAuth Issues</p>
                      <ul className="mt-2 space-y-1 list-disc ml-4">
      ...
      <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="text-center">
            <h4 className="font-bold text-blue-700 mb-2">🤖 AI Support Portal</h4>
            <p className="text-sm text-gray-600 mb-2">Instant assistance 24/7</p>
            <a 
              href="https://supportgenie.help/customer?tenant=supportgenie-tenant" 
              target="_blank" 
              rel="noopener noreferrer"
          ...
          <div className="text-center">
            ...
            <a href="mailto:Help@dubdproducts.com" className="text-green-600 underline">Help@dubdproducts.com</a>
          </div>
        </div>
      </div>
    </div>
  ...
  const VideoTutorialsContent = () => (
    <div className="space-y-8">
        ...
        <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-200">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
              ...
              <div>
                <p className="font-semibold">Account Setup & First Login</p>
                <p className="text-sm text-gray-600">5:32 • Introduction to dashboard</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
              ...
              <div>
                <p className="font-semibold">Navigation & Layout Overview</p>
                <p className="text-sm text-gray-600">3:45 • Understanding the interface</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
              ...
              <div>
                <p className="font-semibold">Subscription Plans Explained</p>
                <p className="text-sm text-gray-600">4:20 • Choosing the right plan</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-200">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
              ...
              <div>
                <p className="font-semibold">Setting Up Lead Scraper</p>
                <p className="text-sm text-gray-600">8:15 • Configuration and targeting</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
              ...
              <div>
                <p className="font-semibold">LinkedIn Lead Discovery</p>
                <p className="text-sm text-gray-600">12:30 • Advanced social media scraping</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
              ...
              <div>
                <p className="font-semibold">Lead Scoring & Qualification</p>
                <p className="text-sm text-gray-600">6:45 • Quality assessment techniques</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-200">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
              ...
              <div>
                <p className="font-semibold">Creating Your First AI Funnel</p>
                <p className="text-sm text-gray-600">15:20 • Complete walkthrough</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
              ...
              <div>
                <p className="font-semibold">Customizing Funnel Templates</p>
                <p className="text-sm text-gray-600">9:30 • Advanced customization</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
              ...
              <div>
                <p className="font-semibold">A/B Testing & Optimization</p>
                <p className="text-sm text-gray-600">11:45 • Performance optimization</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-6 shadow-lg border border-gray-200">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
              ...
              <div>
                <p className="font-semibold">Partner Application Process</p>
                <p className="text-sm text-gray-600">7:20 • Step-by-step application</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
              ...
              <div>
                <p className="font-semibold">Using Partner Sales Tools</p>
                <p className="text-sm text-gray-600">13:10 • Signup links & pricing</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg cursor-pointer hover:bg-gray-100 transition-colors">
              ...
              <div>
                <p className="font-semibold">Marketing Materials & Strategy</p>
                <p className="text-sm text-gray-600">10:50 • Sales deck & resources</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-purple-50 p-6 rounded-lg border border-purple-200">
        <h3 className="text-lg font-bold text-purple-800 mb-2">🎓 Learning Path Recommendation</h3>
        <div className="grid md:grid-cols-4 gap-4 mt-4">
          ...
          <div className="text-center">
            ...
            <p className="text-sm font-semibold">AI Funnel Builder</p>
          </div>
          <div className="text-center">
  ...
  const renderActiveContent = () => {
    switch(activeSection) {
      ...
      case 'ai-swarm-automation':
        return <AISwarmAutomationContent />;
