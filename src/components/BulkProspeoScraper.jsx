    ...
    try {
      ...
      for (let i = 0; i < targetCount; i++) {
        try {
          ...
          // Use multi-provider approach: Hunter.io AND Prospeo!
  ...
  return (
    <div className="bg-gradient-to-br from-purple-500 to-blue-600 rounded-xl shadow-lg p-6 text-white">
      ...
      <div className="text-xs text-purple-200 mt-4 space-y-2">
        <div>💡 All leads auto-save to Recent Leads database. Uses Hunter.io AND Prospeo APIs for maximum coverage!</div>
