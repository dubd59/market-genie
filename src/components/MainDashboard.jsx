      ...
      <div className="flex-1 flex flex-col">
        ...
        {activeSection === 'Market Genie Dashboard' && (
          <div className="min-h-screen bg-gradient-to-br from-white to-blue-50 p-8">
            ...
            <div className="bg-white shadow-lg rounded-xl p-8 mb-10">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Financial Growth</h2>
              ...
              <div className="bg-white shadow-lg rounded-xl p-6 hover:shadow-xl transition-shadow">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div>
                      <p className="font-medium text-gray-800">Campaign "Summer Sale" completed</p>
                  ...
                  <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div>
                      <p className="font-medium text-gray-800">147 new leads imported</p>
                  ...
                  <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div>
                      <p className="font-medium text-gray-800">Automation sequence triggered</p>
        ...
        {activeSection === 'Outreach Automation' && (
          <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-100 p-8">
            <h1 className="text-4xl font-bold text-purple-900 mb-8">Outreach Automation</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white shadow-lg rounded-xl p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">📧 Email Campaigns</h3>
                <p className="text-gray-600 mb-4">Create and send automated email sequences.</p>
                <button className="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg">Create Campaign</button>
              </div>
              <div className="bg-white shadow-lg rounded-xl p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">📱 SMS Campaigns</h3>
                <p className="text-gray-600 mb-4">Send targeted SMS messages to your leads.</p>
                <button className="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg">Send SMS</button>
              </div>
              <div className="bg-white shadow-lg rounded-xl p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">📞 Voice Campaigns</h3>
                <p className="text-gray-600 mb-4">Automated voice calls and voicemail drops.</p>
              ...
              <div className="bg-white shadow-lg rounded-xl p-6">
                ...
                <p className="text-gray-600 mb-4">Automate social media outreach and posting.</p>
        ...
        {activeSection === 'CRM & Pipeline' && (
          <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100 p-8">
            <h1 className="text-4xl font-bold text-green-900 mb-8">CRM & Pipeline</h1>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              ...
              <div className="bg-white shadow-lg rounded-xl p-6 text-center">
                <h3 className="text-lg font-semibold text-gray-700">Qualified</h3>
                <p className="text-3xl font-bold text-yellow-600">524</p>
              </div>
              <div className="bg-white shadow-lg rounded-xl p-6 text-center">
                <h3 className="text-lg font-semibold text-gray-700">Proposals</h3>
            ...
            <div className="bg-white shadow-lg rounded-xl p-6">
              ...
              <p className="text-gray-600">Visual pipeline with drag-and-drop functionality.</p>
            </div>
          </div>
        )}
        ...
        {activeSection === 'Appointments' && (
          <div className="min-h-screen bg-gradient-to-br from-yellow-50 to-amber-100 p-8">
            <h1 className="text-4xl font-bold text-yellow-900 mb-8">Appointments</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white shadow-lg rounded-xl p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">📅 Calendar Integration</h3>
                <p className="text-gray-600 mb-4">Sync with Google Calendar, Outlook, and more.</p>
              ...
              <div className="bg-white shadow-lg rounded-xl p-6">
                ...
                <p className="text-gray-600 mb-4">Send automatic email and SMS reminders.</p>
        ...
        {activeSection === 'Workflow Automation' && (
          <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-100 p-8">
            <h1 className="text-4xl font-bold text-indigo-900 mb-8">Workflow Automation</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-white shadow-lg rounded-xl p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">🔄 Automation Builder</h3>
                <p className="text-gray-600 mb-4">Visual workflow builder with triggers and actions.</p>
                <button className="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg">Build Workflow</button>
              </div>
              <div className="bg-white shadow-lg rounded-xl p-6">
                <h3 className="text-xl font-semibold text-gray-900 mb-4">⚡ Smart Triggers</h3>
                <p className="text-gray-600 mb-4">AI-powered triggers based on user behavior.</p>
